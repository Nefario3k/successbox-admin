              ...
              <template v-slot:item.action="{ item }">
                <div class="user_content">
                  <div class="table__actions">
                    <nuxt-link to="/teacher/525252662772">
                      <svg
                        width="17"
                        height="13"
                        viewBox="0 0 17 13"
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "School Affiliation", value: "category" },
        { text: "School ID", value: "inactive" },
      ...
      bookData: [
        {
          ...
          week: "Literature",
          id: 8755443346,
          category: "Atlantic Hall College",
          inactive: 7876856869,
        ...
        {
          name: "Adefarasin Joseph",
          week: "Mathematics",
          id: 8755443346,
          category: "Green Springs College",
          inactive: 7876856869,
          author: "Kolawole Abraham",
          phone: "090123456789",
          email: "williams.ebube@gmail.com",
