              ...
              <template v-slot:item.action="{ item }">
                <div class="user_content">
                  <div class="table__actions">
                    <nuxt-link to="/school/525252662772">
                      <svg
                        width="17"
                        height="13"
                        viewBox="0 0 17 13"
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "ID", value: "id" },
        { text: "Total Req", value: "week" },
        { text: "Active Req", value: "category" },
        { text: "Inactive Req", value: "inactive" },
        { text: "PCP Name", value: "author" },
        { text: "PCP Phone", value: "phone" },
        { text: "PCP Email", value: "email" },
